...
import { CheckCircle2, Clock, FileText, ArrowLeft, Home } from "lucide-react";
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{format(new Date(submission.created_at), "PPP 'at' p")}</p>
                </div>
              </div>
              ...
              {submission.total_estimated_value && (
                <div>
                  <p className="text-sm text-muted-foreground mb-1">Total Estate Value</p>
                  <p className="text-lg font-semibold">
                    ${submission.total_estimated_value.toLocaleString()}
                  </p>
                </div>
              )}
